                    ...
                    <div class="block-content block-content-full tab-content px-md-5" style="min-height: 300px;">
                        ...
                        <div class="tab-pane active" id="wizard-progress-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="wizard-progress-appointment" name="appointment"
                        ...
                        <div class="tab-pane" id="wizard-progress-step3" role="tabpanel">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" id="wizard-progress-email" name="bloomber_email"
                                    value="{{ $user->bloomber_email }}">
                            </div>
                            <div class="form-group">

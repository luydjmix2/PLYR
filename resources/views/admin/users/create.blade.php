...
@section('content')
@section('title-page')
{{ trans('users.namePageCreate') }}
@endsection
@section('breadcrumbs')
{{ Breadcrumbs::render(trans('users.namePageCreate')) }}
@endsection
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block-content">
                    ...
                    @endif
                    {!! Form::open(['route'=> 'users.store', 'method' => 'POST', 'id' => 'userCreate' ]) !!}
                    @csrf
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {{Form::select('profile', Helper::listProfile(), old('profile'), ['class'=>'form-control', "id"=>"profile"])}}
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">                        
